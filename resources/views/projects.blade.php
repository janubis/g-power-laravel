									...
									<div class="grid-inner">
										...
										<div class="portfolio-desc">
											<a href="/projects/{{$singleproject->id}}">
												...
												@if ($singleproject->category == 'operation')
												<p><span>System Capacity: </span>{{$singleproject->capacity}} кВт</p>
												@else
												...
												<p><span>Хүлээлгэн өгсөн огноо: </span>{{date('Y/m', strtotime($singleproject->delivered_date))}}</p>
											</a>
										</div>
									</div>
								</article>
