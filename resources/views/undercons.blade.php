			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						<!-- Logo
						============================================= -->
						<div id="logo" class="mx-auto border-0 px-0" style="margin: 20px;">
							<a href="index.html" class="standard-logo" data-dark-logo="/gpower/assets/logo-edited.png"><img src="/gpower/assets/logo-edited.png" alt="G-Power Logo"></a>
							<a href="index.html" class="retina-logo" data-dark-logo="/gpower/assets/logo-edited.png"><img src="/gpower/assets/logo-edited.png" alt="G-Power Logo"></a>
						</div><!-- #logo end -->
